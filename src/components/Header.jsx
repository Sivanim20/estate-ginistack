...
const Header = () => {
  return (
    <div className='min-h-screen mb-4 bg-cover bg-gray-600 bg-center flex 
    items-center w-full overflow-hidden' style={{backgroundImage: `url(${headerImage})`}} id='Header'>
        <Navbar/>
        <motion.div 
