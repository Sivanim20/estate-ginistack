  ...
  return (
    ...
    id='About'>
        ...
        <div className='flex flex-col md:flex-row items-center md:items-start md:gap-20 '>
          ...
          <div className='items-center md:items-start mt-0 text-gray-600'>
            ...
            <p className='my-10 max-w-lg text-center md:text-left'>Lorem Ipsum is simply dummy text of the printing and typesetting 
              industry. Lorem Ipsum has been the industry's standard dummy text ever 
              since the 1500s, when an unknown printer took a galley of type and 
              scrambled it to make a type specimen book. </p>
              <button className='bg-blue-600 text-white py-2 px-2 border border-gray-300 rounded-[10px]'>Learn More</button>
          </div>
