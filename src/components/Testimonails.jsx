...
const Testimonails = () => {
  return (
    ...
    className='container mx-auto py-10 lg:px-32 w-full overflow-hidden' id='Testimonails'>
        ...
        <p className='text-gray-500 max-w-80 text-center mb-8 max-w-80 mx-auto mt-8'>Real Stories from Those Who Found Home with Us</p>
          ...
          {testimonialsData.map((testimonials, index)=>(
            <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 text-center'>
              ...
              <p className='text-gray-500'>{testimonials.title}</p>
